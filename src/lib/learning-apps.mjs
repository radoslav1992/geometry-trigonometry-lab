...
export const currentApp = "geometry";
...
export const relatedLearning = {
  "trigonometric-ratios": [
    {
      "app": "astronomy",
      "path": "/labs/stellar-parallax/",
      "title": "Take your triangles into space",
      "description": "Astronomers use angles and a known baseline to estimate the distance to nearby stars. Try the stellar parallax experiment.",
      "label": "Measure a star’s distance"
    }
  ],
  "radians-and-degrees": [
    {
      "app": "astronomy",
      "path": "/labs/orbit-simulator/",
      "title": "See angles in orbit",
      "description": "Go from angles around a circle to a planet’s journey around a star. Explore how the orbit changes with distance.",
      "label": "Explore the orbit simulator"
    }
  ]
};
